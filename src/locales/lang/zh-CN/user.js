export default {
  ...
  'user.login.password': '口令',
  'user.login.username.placeholder': '账户: ',
  'user.login.password.placeholder': '口令: ',
  'user.login.message-invalid-credentials': '账户或口令错误（admin/ant.design）',
  'user.login.message-invalid-verification-code': '验证码错误',
  'user.login.tab-login-credentials': '账户口令登录',
  ...
  'user.login.forgot-password': '忘记口令',
  'user.login.sign-in-with': '其他登录方式',
  'user.login.signup': '注册账户',
  'user.login.login': '登录',
  'user.register.register': '注册',
  'user.register.email.placeholder': '邮箱',
  'user.register.password.placeholder': '口令, 请至少输入 10 个字符。',
  'user.register.password.popover-message': '请至少输入 10 个字符。',
  'user.register.confirm-password.placeholder': '确认口令',
  ...
  'user.username.required': '请输入用戶名！',
  'user.email.wrong-format': '邮箱地址格式错误！',
  'user.userName.required': '请输入帐户名或邮箱地址',
  'user.password.required': '请输入口令！',
  'user.password.twice.msg': '两次输入的口令不匹配!',
  'user.password.strength.msg': '口令强度不够 ',
  ...
  'user.confirm-password.required': '请确认口令！',
